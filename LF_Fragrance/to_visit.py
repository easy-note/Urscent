...
def info_crawler(url_data,chrome_options, cookies, write_file):
    ...
    for i in tqdm(range(len(url_data))):
        data = {}
        ...
        if len(datas) % 100 == 0:
            ...
            write_file.to_csv('/home/dhkim/Fragrance/data/missing_DB.csv' ,encoding ='utf-8-sig',  index=False)
            datas.clear()
...
if __name__ == '__main__':
    ...
    DB = DB[0:0]
    url_data = pd.read_csv('/home/dhkim/Fragrance/data/to_visit.csv', encoding ='utf-8-sig')
